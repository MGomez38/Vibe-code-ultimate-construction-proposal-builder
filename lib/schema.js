...
-- Priced by formula rather than by list: the shop's own rates and labor
-- times, so a steel increase re-prices every size instead of none of them.
CREATE TABLE IF NOT EXISTS fab_models (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  company_id INTEGER REFERENCES companies(id),
  kind TEXT NOT NULL DEFAULT 'duct',
